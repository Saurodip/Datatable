...
export class AppComponent implements OnInit {
  ...
  private prepareDataTableHeader = (): void => {
    this.header = [
      { propertyName: 'SerialNo', title: 'Serial No.', type: 'integer', columnWidth: '200px', isFrozen: false },
      { propertyName: 'ProductName', title: 'Product Name', type: 'string', columnWidth: '200px', isFrozen: false },
